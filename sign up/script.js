...
const confirmPasswordContainer = document.querySelector('.ConfirmPass-container');
...
const passMismatchError = document.createElement("p");
passMismatchError.classList.add("error_text");
passMismatchError.textContent = passwordMismatchError;

continueBtn.addEventListener('click', checkForm);
...
function checkForm(e) {
    ...
    const confirmPasswordInput = document.getElementById('confirmPassInput').value;
    ...
    if (passwordInput !== confirmPasswordInput) {
        confirmPasswordContainer.appendChild(passMismatchError);
        isValid = false;
    }
